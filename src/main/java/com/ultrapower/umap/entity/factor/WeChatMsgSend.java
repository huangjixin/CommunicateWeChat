...
import com.wechat.send.WeChatData;
...
public class WeChatMsgSend {
     ...
     * @return String
     */
    public String createpostdata(String touser,int toparty, String msgtype,
    ...
    public String toJsonStringData(String  touser,int toparty,String totag,String msgtype,int agentid,String content){
    ...
    public String createpostDepartmentData(int toparty, String msgtype, String contentKey ,String contentValue) {
        WeChatData wcd = new WeChatData();
        wcd.setToparty(toparty);
        wcd.setMsgtype(msgtype);
        Map<Object, Object> content = new HashMap<Object, Object>();
